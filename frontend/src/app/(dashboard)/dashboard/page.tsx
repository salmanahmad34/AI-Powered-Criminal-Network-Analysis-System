  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="pb-6 border-b border-[var(--border)]">
        <span className="text-[10px] font-bold text-[var(--teal-accent)] tracking-widest uppercase block mb-2">CRIMEGRAPH AI</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {[
          ...
          <Link
            key={stat.name}
            href={stat.href}
            className="bg-white border border-[var(--card-border)] rounded-xl p-5 hover:border-[var(--teal-accent)]/40 hover:shadow-sm transition-all group"
          >
            <div className="flex items-start justify-between mb-3">
              <div className="p-2 bg-[var(--surface-muted)] rounded-lg group-hover:bg-[var(--teal-muted)] transition-colors">
            ...
            <p className="text-[10px] font-semibold text-[var(--text-tertiary)] uppercase tracking-wider mt-1">{stat.name}</p>
            <p className="text-[10px] text-[var(--text-tertiary)] mt-1">{stat.change}</p>
          </Link>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white border border-[var(--card-border)] rounded-xl p-6 space-y-5">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="p-4 bg-[var(--surface-muted)] border border-[var(--border-subtle)] rounded-lg flex items-center justify-between gap-4 hover:border-[var(--card-border)] transition-all">
                ...
                <span className={`px-2 py-0.5 rounded text-[8px] font-bold border tracking-wider uppercase shrink-0 ${alert.bg} ${alert.border} ${alert.text}`}>
                  {alert.severity}
                </span>
              </div>
            ))}
            ...
            {[
              ...
              <div key={i} className="space-y-2">
                <div className="flex justify-between text-xs font-semibold">
                  <span className="text-[var(--text-primary)] truncate max-w-[180px]">{job.file}</span>
